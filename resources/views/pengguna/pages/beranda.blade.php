...
@section ('content')
						...
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="{{asset('inputan/img/')}}/{{$sliders->gambar_slider}}" alt="">
								</div>
							</div>
						</div>
						@endforeach
	...
	<section class="features-area section_gap">
		<div class="container">
			...
			<div class="row features-inner justify-content-center" >
				 @foreach ($kategoris  as $kategoris)
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					<a href="{{route('kategoripengguna',$kategoris->id)}}" >
					<div class="single-features">
						<div class="f-icon">
							<img class="img-fluid" src="{{asset('inputan/img/')}}/{{$kategoris->gambarkat}}" alt="" >
						</div>
						<h6>{{$kategoris->namakat}}</h6>
