    ...
    <div class="container">
        ...
        <table class="styled-table">
            <thead>
                ...
                <tr>
                    <th>Nomor Hp</th>
                    <td style="color: black; background-color: #ffffff">{{ Auth::user()->nomor_hp }}</td>
                </tr>
                <tr>
                    <th>Kota</th>
                    <td style="color: black; background-color: #ffffff">{{ Auth::user()->kota->nama }}</td>
                </tr>
                <tr>
                    <th>Provinsi</th>
                    <td style="color: black; background-color: #ffffff">{{ Auth::user()->provinsi->nama }}</td>
                </tr>
            </thead>
        </table>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $items['produk']['namaproduk'] }}</td>
                    <td>{{ $items['kuantitas'] }}</td>
                    <td>@currency($items['produk']['harga'])</td>
                </tr>
                @php
                    $total_bayar += ($items['produk']['harga'] * $items['kuantitas'])
                @endphp
                @endforeach
                @php
